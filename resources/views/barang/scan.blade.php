...
<html lang="en">
<head>
	<title>Enrty Data Sarpras</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="POST" action="{{ route('scan.store') }}">
					@csrf
					<span class="login100-form-title">
					{{$barang->nama}} ({{$barang->ukuran}}) <br> Tersedia {{$barang->stok}} 
					</span>
                    <div class="wrap-input100 validate-input" data-validate = "NIS Harus Di isi">
                        <input class="input100" type="hidden" name="id" value="{{$barang->id}}" placeholder="Username" readonly>
						<input class="input100" type="text" name="" value="{{$barang->nama}} ({{$barang->ukuran}})" placeholder="Username" readonly>
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "">
						<input class="input100" type="text" name="" value="Rp. {{number_format($barang->harga_jual)}}" placeholder="Username" readonly>
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-id-badge" aria-hidden="true"></i>
						</span>
					...
					<div class="wrap-input100 validate-input" data-validate = "Jumlah Harus Diisi">
						<input class="input100" type="text" name="jumlah" value="{{old('jumlah')}}" placeholder="Jumlah">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-id-badge" aria-hidden="true"></i>
						</span>
					...
					<div class="wrap-input100 validate-input" data-validate= "Password Harus Diisi">
						<input class="input100" type="text" name="keterangan" placeholder="Keterangan">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
					...
					<div class="text-center p-t-12">
						<span class="txt1">
							Pastikan Nama dan Jumlah Barang Sesuai
						</span>
					</div>
